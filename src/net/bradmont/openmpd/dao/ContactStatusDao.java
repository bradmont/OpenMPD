...
public class ContactStatusDao extends AbstractDao<ContactStatus, Long> {
    ...
    */
    ...
    private Query<ContactStatus> contact_StatusesQuery;
    ...
    /** Internal query to resolve the "statuses" to-many relationship of Contact. */
    public List<ContactStatus> _queryContact_Statuses(Long contactId) {
        synchronized (this) {
            if (contact_StatusesQuery == null) {
                QueryBuilder<ContactStatus> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.ContactId.eq(null));
                contact_StatusesQuery = queryBuilder.build();
            }
        }
        Query<ContactStatus> query = contact_StatusesQuery.forCurrentThread();
